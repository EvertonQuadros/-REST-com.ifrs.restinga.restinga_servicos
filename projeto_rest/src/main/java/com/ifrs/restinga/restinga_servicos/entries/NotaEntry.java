...
import com.ifrs.restinga.restinga_servicos.classes.Nota;
 ...
 * @author not275ssd
 */
//http://localhost:8080/entry-point/restingaservicos/nota
@Path("/entry-point/restingaservicos/nota")
public class NotaEntry extends EntryPoint{
    
    public NotaEntry() {
        super(NotaEntry.class,
                Nota.class,
