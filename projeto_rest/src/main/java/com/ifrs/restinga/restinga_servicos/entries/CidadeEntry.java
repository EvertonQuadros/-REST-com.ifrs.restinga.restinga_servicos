...
import com.ifrs.restinga.restinga_servicos.classes.Cidade;
 ...
 * @author Convidado
 */
//http://localhost:8080/entry-point/restingaservicos/cidade
@Path("/entry-point/restingaservicos/cidade")
public class CidadeEntry extends EntryPoint{

    public CidadeEntry() {
        super(CidadeEntry.class,
                Cidade.class,
                "/entry-point/restingaservicos/cidade");  
    }
