...
import com.ifrs.restinga.restinga_servicos.classes.Pessoa;
 ...
 * @author not275ssd
 */
//http://localhost:8080/entry-point/restingaservicos/pessoa
@Path("/entry-point/restingaservicos/pessoa")
public class PessoaEntry extends EntryPoint {

    public PessoaEntry() {
        super(PessoaEntry.class,
                Pessoa.class,
                "/entry-point/restingaservicos/pessoa");
    }
